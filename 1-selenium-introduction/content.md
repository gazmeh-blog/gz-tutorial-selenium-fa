 ...
 * [**کنترل از راه دور سلنیوم**](#کنترل-از-راه-دور-سلنیوم)
 * [**محیط توسعه سلنیوم یا IDE**](#محیط-توسعه-سلنیوم-یا-ide)
 * [**سلنیوم وب درایور**](#سلنیوم-وب-درایور)
 * [**سلنیوم Grid**](#سلنیوم-grid)
...
| پشتیبانی از تکنولوژی           | در حین خودکارسازی برنامه‌های SAP، Salesforce، Mainframe  با مشکل مواجه می‌شود.                                     | تقریباً از هر برنامه و محیط نرم‌افزاری از جمله SAP ،Oracle ، فریم‌ورک‌های تعبیه شده، مرورگرهای headless  و ... پشتیبانی می‌کند. |

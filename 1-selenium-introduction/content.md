...
| پشتیبانی از تکنولوژی           | در حین خودکارسازی برنامه‌های SAP، Salesforce، Mainframe  با مشکل مواجه می‌شود.                                     | تقریباً از هر برنامه و محیط نرم‌افزاری از جمله SAP ،Oracle ،Salesforce mainframe، ها، فریم‌ورک‌های تعبیه شده، مرورگرهای headless   و ... پشتیبانی می‌کند. |
